-- Half Yearly Maintenance (17000 KM) Checklist Schema
-- This table stores half-yearly/17000km periodic maintenance records by technicians

CREATE TABLE IF NOT EXISTS public.halfyearly_maintenance (
...
CREATE INDEX IF NOT EXISTS idx_halfyearly_maintenance_vehicle_id ON public.halfyearly_maintenance(vehicle_id);
CREATE INDEX IF NOT EXISTS idx_halfyearly_maintenance_from_month ON public.halfyearly_maintenance(from_month);

-- Sample insert statement
INSERT INTO public.halfyearly_maintenance (
    ...
    '2024-09-15', '17000', 'Checked and topped up', 'Oil level normal', 'Pump Oil', '0.5L', 'BILL001/15-09-2024', '₹250',
    '2024-09-15', '17000', 'Cleaned and refilled', 'Filter cleaned', 'Air Filter Oil', '0.3L', 'BILL002/15-09-2024', '₹150'
);
