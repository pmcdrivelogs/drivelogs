...
@app.route('/hr/employee/set-status/<path:employee_id>', methods=['POST'])
@admin_required
def hr_set_employee_status(employee_id):
    ...
    if new_status not in allowed:
        new_status = 'inactive'
    try:
        supabase.table('employees').update({'status': new_status}).eq('employee_id', employee_id).execute()
        flash(f'Employee status updated to {new_status}.', 'success')
    except Exception as e:
...
def hr_employees():
    ...
    try:
        ...
        inactive_employees = [e for e in employees if e.get('status') != 'active']
    ...
    if request.method == 'POST':
        try:
            ...
            employee_data = {
                ...
                'name': (request.form.get('name') or '').upper() or None,
                'profile_post': request.form.get('profile_post'),
                'profile_post_other': (request.form.get('profile_post_other') or '').upper() or None,
                'blood_group': request.form.get('blood_group'),
                'age': request.form.get('age') or None,
                'dl_no': (request.form.get('dl_no') or '').upper() or None,
                'date_of_birth': request.form.get('date_of_birth') or None,
                'date_of_issue': request.form.get('date_of_issue') or None,
                'badge_no': (request.form.get('badge_no') or '').upper() or None,
                'lmv_date_of_issue': request.form.get('lmv_date_of_issue') or None,
                'rto_ref': (request.form.get('rto_ref') or '').upper() or None,
                ...
                'other_habits': (request.form.get('other_habits') or '').upper() or None,
                'father_name': (request.form.get('father_name') or '').upper() or None,
                'father_age': request.form.get('father_age') or None,
                'father_occupation': (request.form.get('father_occupation') or '').upper() or None,
                'father_gender': request.form.get('father_gender'),
                'mother_name': (request.form.get('mother_name') or '').upper() or None,
                'mother_age': request.form.get('mother_age') or None,
                'mother_occupation': (request.form.get('mother_occupation') or '').upper() or None,
                'mother_gender': request.form.get('mother_gender'),
                'spouse_name': (request.form.get('spouse_name') or '').upper() or None,
                'spouse_age': request.form.get('spouse_age') or None,
                'spouse_occupation': (request.form.get('spouse_occupation') or '').upper() or None,
                'spouse_gender': request.form.get('spouse_gender'),
                'child1_name': (request.form.get('child1_name') or '').upper() or None,
                'child1_age': request.form.get('child1_age') or None,
                'child1_occupation': (request.form.get('child1_occupation') or '').upper() or None,
                'child1_gender': request.form.get('child1_gender'),
                'child2_name': (request.form.get('child2_name') or '').upper() or None,
                'child2_age': request.form.get('child2_age') or None,
                'child2_occupation': (request.form.get('child2_occupation') or '').upper() or None,
                'child2_gender': request.form.get('child2_gender'),
                'child3_name': (request.form.get('child3_name') or '').upper() or None,
                'child3_age': request.form.get('child3_age') or None,
                'child3_occupation': (request.form.get('child3_occupation') or '').upper() or None,
                ...
                'nominee_relation': (request.form.get('nominee_relation') or '').upper() or None,
                'nominee_gender': request.form.get('nominee_gender'),
                'date_of_joining': request.form.get('date_of_joining') or None,
                'driving_nature': (request.form.get('driving_nature') or '').upper() or None,
                'route': (request.form.get('route') or '').upper() or None,
                'reference': (request.form.get('reference') or '').upper() or None,
                ...
                'status': 'active',
                'bank_name': (request.form.get('bank_name') or '').upper() or None,
                'account_number': request.form.get('account_number'),
                'account_holder_name': (request.form.get('account_holder_name') or '').upper() or None,
                'ifsc_code': (request.form.get('ifsc_code') or '').upper() or None,
                'branch': (request.form.get('branch') or '').upper() or None,
